...
public:
	...
	static const std::string NOM_BALLE;
	static const std::string NOM_BONUS;
	static const std::string NOM_BORDURE;
	static const std::string NOM_SABLE;
	static const std::string NOM_TROU;
	static const std::string NOM_EAU;
	static const std::string NOM_TERRAIN;
	static const std::string NOM_BATON;
	static const std::string NOM_FLECHE;
	static const std::string NOM_CONTOUR;
	static const std::string NOM_PORTAL;
