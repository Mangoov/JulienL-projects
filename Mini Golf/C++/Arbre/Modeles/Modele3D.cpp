...
Modele3D::~Modele3D()
{
	...
	glDeleteTextures(mapTextures_.size(), identificateursTextures_);
...
void Modele3D::chargerTextures()
{
	...
	// Nombre de textures
	int nombreTextures = mapTextures_.size();
	...
	// Itérateur STL
	map<string, GLuint*>::iterator itr = mapTextures_.begin();

	for (int j=0; j<nombreTextures; j++) {
		string nomFichier = itr->first;
		itr->second = &(identificateursTextures_[j]);
		itr++;

		// Charger la texture
		aidegl::glLoadTexture(string("media/") + nomFichier, identificateursTextures_[j], false);
	}
...
///
////////////////////////////////////////////////////////////////////////
void Modele3D::dessiner()
{
	dessinerNoeud(scene_, scene_->mRootNode);
}
...
///
////////////////////////////////////////////////////////////////////////
void Modele3D::dessinerNoeud(const aiScene* scene, const aiNode* noeud)
{
	...
	for (int i=0; i<noeud->mNumMeshes; i++) {
...
//		glMaterialfv(GL_FRONT_AND_BACK, GL_DIFFUSE, c);
	...
	for (int i=0; i<noeud->mNumChildren; i++) {
		dessinerNoeud(scene, noeud->mChildren[i]);
	}
...
////////////////////////////////////////////////////////////////////////
///
/// @fn void Modele3D::calculerSphereEnglobante() const
/// 
/// Calculer les spheres englobantes
///
/// @return sqrt(max).
///
////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////
///
/// @fn void Modele3D::calculerCylindreEnglobant(double& rayon, double& bas, double& haut) const
/// 
/// Calculer les cylindres englobantes
///
/// @param[in] rayon : rayon du cylindre
/// @param[in] bas : bas du cylindre
/// @param[in] haut : haut du cylindre
///
/// @return Aucun.
///
////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////
///
/// @fn void Modele3D::calculerBoiteEnglobante(Vecteur3& coinMin, Vecteur3& coinMax) const
/// 
/// Calculer les boites englobantes
///
/// @param[in] coinMin : coin minimum de la boite
/// @param[in] coinMax : coin maximum de la boite
///
/// @return Aucun.
///
////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////
///
/// @fn void Modele3D::obtenirPointsExtremes(Vecteur3& xMin, Vecteur3& xMax,
///										Vecteur3& yMin, Vecteur3& yMax, 
///										Vecteur3& zMin, Vecteur3& zMax) const
/// 
/// Obtenir les points extremes
///
/// @param[in] xMax : xMax du point extreme
/// @param[in] xMin : xMin du point extreme
/// @param[in] yMin : yMin du point extreme
/// @param[in] yMax : yMax du point extreme
/// @param[in] zMin : zMin du point extreme
/// @param[in] zMax : zMax du point extreme
///
/// @return Aucun.
///
////////////////////////////////////////////////////////////////////////
