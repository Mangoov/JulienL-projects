...
public class Exemple implements Runnable {
   ...
   private class GestionnaireClavier extends KeyAdapter {
      ...
      public void keyPressed(KeyEvent evenement) {
    	  ...
    	  switch(evenement.getKeyCode()){
	    	  ...
	    	  case KeyEvent.VK_UP :   		   
	        	  	fctC_deplacerXY( 0,canvas_.getHeight()*1/20);
	    	  ...
	    	  case KeyEvent.VK_RIGHT :   		   
		      	  	fctC_deplacerXY( -canvas_.getWidth()*1/20,0);
   ...
   public class GestionnaireSouris implements MouseListener {
	   ...
	   public GestionnaireSouris(Object gestionnaire) {
	         gestionnaire_ = gestionnaire;
	      }
	    public void mousePressed(MouseEvent evenement) {
	      	 ...
	      	 if(evenement.getButton() == MouseEvent.BUTTON1){
			            ...
			            LastX = evenement.getX();
			            LastY = evenement.getY();
			            quelClick = 1;
	      	 }
	      	 else if(evenement.getButton() == MouseEvent.BUTTON3){
	      		 		quelClick = 3;
	      		 		 coin1X = evenement.getX();
	      		 		coin1Y = evenement.getY();
	      		 		//fctC_zoomerInElastique(evenement.getX(), evenement.getY(),0,0);
	      		 		System.out.println(
	    		                  "click droit");
	      	 }
	...
	public void mouseReleased(MouseEvent evenement) {
		// TODO Auto-generated method stub
		  if(quelClick == 3){
     		  coin2X = evenement.getX();
     		  coin2Y = evenement.getY();
     		  System.out.println(coin2X);
     		  System.out.println(coin2Y);
     		  System.out.println(coin1X);
     		  System.out.println(coin1Y);
     		  fctC_zoomerInElastique(coin1X, coin1Y, coin2X, coin2Y);
     	  }
 ...
 /*     canvas_.addMouseListener(new MouseAdapter() {
      ...
      canvas_.addMouseMotionListener(new MouseAdapter() {  
    	  public void mouseDragged(MouseEvent evenement){
    		  	if(quelClick == 1){
	    		  	//calculer le déplacement nécessaire
	         	     int newX = (evenement.getX() - LastX);  
	         	     int newY =  (evenement.getY() - LastY);
	         	  
	         	     fctC_deplacerXY(-1.2*newX,newY);   
      ...
      canvas_.addMouseWheelListener(new MouseAdapter() {
    ...
    /*  canvas_.addMouseListener(new MouseAdapter() {
      ...
      canvas_.addMouseListener(new GestionnaireSouris(this));
